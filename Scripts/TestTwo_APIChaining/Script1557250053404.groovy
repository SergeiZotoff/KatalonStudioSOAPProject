...
def countryCode = dataValue.ListOfCountryNamesByNameResponse.ListOfCountryNamesByNameResult.tCountryCodeAndName[127].sISOCode.text()

GlobalVariable.countryCode = countryCode

println(".....value for Gloabal Variable is: " + GlobalVariable.countryCode)
